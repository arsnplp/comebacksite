...
export const site = {
  ...
  description:
    "Créez votre carte de fidélité digitale en 10 minutes. Vos clients l'ajoutent à leur téléphone en 1 scan et reviennent 2× plus souvent. Essai gratuit 30 jours, sans CB.",
  locale: "fr_FR",
...
export const routes: { path: string; priority: number; changeFrequency: "daily" | "weekly" | "monthly" }[] = [
  ...
  { path: "/essai-gratuit", priority: 0.9, changeFrequency: "monthly" },
