...
Concrètement, avant de remettre un euro en publicité, vérifiez ces trois points : chaque client qui paie se voit-il proposer une raison chiffrée de revenir ? Un client qui décroche est-il relancé automatiquement ? Savez-vous, en euros, ce que vos habitués vous rapportent ? Si la réponse est trois fois non, votre meilleur investissement marketing n'est pas une campagne : c'est un programme de fidélité. Le [guide complet de la fidélisation](/guide-fidelisation) détaille comment le lancer en trois semaines.

## Passez à l'action : trois gestes cette semaine

D'abord, mesurez. Avant de réallouer un seul euro, estimez ce que vos clients existants représentent : combien reviennent chaque mois, à quelle fréquence, pour quel panier. Notre [calculateur](/calculateur) vous donne un ordre de grandeur en dix secondes.

Ensuite, équipez-vous d'un moyen de recontacter vos clients. Un client qui sort de votre boutique sans laisser de trace est un client que vous ne pouvez ni relancer ni remercier. C'est précisément le rôle d'une [carte de fidélité digitale](/carte-fidelite-papier-ou-digitale) : chaque scan enrichit votre fichier client, sans formulaire ni carte en carton.

Enfin, réservez votre budget d'acquisition aux périodes où il travaille vraiment : ouverture, lancement d'une nouvelle offre, saison haute. Le reste de l'année, chaque euro investi dans le retour de vos clients existants rapporte davantage, car il s'adresse à des gens déjà convaincus. En résumé, l'acquisition remplit la salle une fois ; la fidélisation la remplit toutes les semaines.
