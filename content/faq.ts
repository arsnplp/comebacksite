...
export const homeFaq: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Le plan Starter est gratuit, jusqu'à 30 clients. Ensuite, 9,99 € HT par mois pour le plan Pro (100 clients et relances automatiques) et 39,99 € pour le plan Business (clients et notifications illimités). Aucun frais d'installation, aucun matériel à acheter. Commencez par l'essai gratuit de 30 jours : testez d'abord avec vos vrais clients, décidez ensuite, chiffres en main.",
  },
  {
